...
const siteData = {
    ...
    research: [
        {
            ...
            topics: [
                { title: "智能导航系统", description: "研究机器人在复杂环境中的自主导航能力", image: "assets/images/research/placeholder.jpg" },
                { title: "人机交互技术", description: "开发自然、高效的人机交互方式", image: "assets/images/research/placeholder.jpg" }
            ],
            students: [
                { name: "张三", level: "博士生", direction: "机器人路径规划与导航", year: "2022", image: "assets/images/students/placeholder.jpg", intro: "主要研究基于深度强化学习的机器人自主导航算法。" }
            ]
        },
        {
            id: "computer-vision",
    ...
    service: {
        reviewer: [
            { venue: "IEEE TPAMI", years: "2022-至今", role: "审稿人" },
            { venue: "CVPR", years: "2023-至今", role: "审稿人" }
        ],
        committee: [
            { role: "程序委员会委员", conference: "ICML 2024", year: 2024 }
        ],
        editor: []
    },
    ...
    competitions: [
        {
            ...
            images: ["assets/images/test/placeholder.jpg"]
        }
    ],
